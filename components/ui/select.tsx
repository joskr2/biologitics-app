...
function SelectGroup({
	className,
	...props
}: ReadonlyProps<SelectPrimitive.Group.Props>) {
	return (
...
function SelectValue({
	className,
	...props
}: ReadonlyProps<SelectPrimitive.Value.Props>) {
	return (
...
function SelectLabel({
	className,
	...props
}: ReadonlyProps<SelectPrimitive.GroupLabel.Props>) {
	return (
...
function SelectItem({
	...
	children,
	...props
}: ReadonlyProps<SelectPrimitive.Item.Props>) {
	return (
...
function SelectSeparator({
	className,
	...props
}: ReadonlyProps<SelectPrimitive.Separator.Props>) {
	return (
