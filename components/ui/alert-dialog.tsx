...
function AlertDialog({
	...props
}: ReadonlyProps<AlertDialogPrimitive.Root.Props>) {
	return <AlertDialogPrimitive.Root data-slot="alert-dialog" {...props} />;
}

function AlertDialogTrigger({
	...props
}: ReadonlyProps<AlertDialogPrimitive.Trigger.Props>) {
	return (
...
function AlertDialogPortal({
	...props
}: ReadonlyProps<AlertDialogPrimitive.Portal.Props>) {
	return (
...
function AlertDialogOverlay({
	className,
	...props
}: ReadonlyProps<AlertDialogPrimitive.Backdrop.Props>) {
	return (
