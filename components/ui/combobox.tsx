...
import type { ReadonlyProps } from "@/lib/readonly-props";
...
function ComboboxValue({
	...props
}: ReadonlyProps<ComboboxPrimitive.Value.Props>) {
...
function ComboboxTrigger({
	...
	children,
	...props
}: ReadonlyProps<ComboboxPrimitive.Trigger.Props>) {
	return (
...
function ComboboxClear({
	className,
	...props
}: ReadonlyProps<ComboboxPrimitive.Clear.Props>) {
	return (
...
function ComboboxList({
	className,
	...props
}: ReadonlyProps<ComboboxPrimitive.List.Props>) {
	return (
...
function ComboboxItem({
	...
	children,
	...props
}: ReadonlyProps<ComboboxPrimitive.Item.Props>) {
	return (
...
function ComboboxGroup({
	className,
	...props
}: ReadonlyProps<ComboboxPrimitive.Group.Props>) {
	return (
...
function ComboboxLabel({
	className,
	...props
}: ReadonlyProps<ComboboxPrimitive.GroupLabel.Props>) {
	return (
...
function ComboboxCollection({
	...props
}: ReadonlyProps<ComboboxPrimitive.Collection.Props>) {
	return (
...
function ComboboxEmpty({
	className,
	...props
}: ReadonlyProps<ComboboxPrimitive.Empty.Props>) {
	return (
...
function ComboboxSeparator({
	className,
	...props
}: ReadonlyProps<ComboboxPrimitive.Separator.Props>) {
	return (
...
function ComboboxChips({
	className,
	...props
}: ReadonlyProps<ComboboxPrimitive.Chips.Props> &
...
function ComboboxChip({
	...
	showRemove = true,
	...props
}: ReadonlyProps<ComboboxPrimitive.Chip.Props> & {
	showRemove?: boolean;
}) {
	return (
...
function ComboboxChipsInput({
	className,
	...props
}: ReadonlyProps<ComboboxPrimitive.Input.Props>) {
	return (
		<ComboboxPrimitive.Input
